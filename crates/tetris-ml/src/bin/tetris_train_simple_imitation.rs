...
use tetris_tensor::tensors::TetrisPieceOrientationLogitsTensor;
use tetris_tensor::tensors::{TetrisPieceOrientationTensor, TetrisPieceTensor};
...
impl TetrisSimpleImitationPolicy {
    ...
    pub fn forward_logits(
        ...
        let dtype = tetris_tensor::fdtype();
